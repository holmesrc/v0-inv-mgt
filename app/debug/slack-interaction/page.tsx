...
export default function SlackInteractionDebugPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl">Slack Interaction Debug</CardTitle>
          <CardDescription>Test Slack interactive messages and button actions</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="mt-4 p-4 border rounded-md bg-blue-50">
            ...
            <ol className="list-decimal list-inside space-y-2">
              ...
              <li>Click the Approve or Reject button in the Slack message</li>
              <li>The message should update to show the action was successful</li>
            </ol>
          </div>
        </CardContent>
      </Card>
